    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_points_currency', djmoney.models.fields.CurrencyField(choices=[('BHD', 'Bahraini Dinar'), ('EGP', 'Egyptian Pound'), ('KWD', 'Kuwaiti Dinar'), ('OMR', 'Omani Rial'), ('QAR', 'Qatari Riyal'), ('SAR', 'Saudi Riyal'), ('AED', 'United Arab Emirates Dirham')], default=None, editable=False, max_length=3)),
                ('referral_points', djmoney.models.fields.MoneyField(decimal_places=2, help_text='Points awarded for referring a new user.', max_digits=14, verbose_name='Referral Points')),
            ],
            options={
