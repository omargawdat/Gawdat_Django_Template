    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now)),
                ('language', models.CharField(choices=[('en', 'English'), ('ar', 'Arabic')], default='ar', max_length=10)),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(db_index=True, help_text='Should start with country code as (+966)', max_length=128, region=None, verbose_name='Phone Number')),
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('NS', 'Not Selected')], default='NS', max_length=10, verbose_name='Gender')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(help_text='Should start with country code as (+966)', max_length=128, region=None, unique=True, verbose_name='Phone Number')),
